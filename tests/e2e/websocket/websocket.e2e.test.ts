...
describe('WebSocket gateway event contract (integration-style)', () => {
  ...
  it('wires connection listeners and room joins', () => {
  ...
  it('emits message, typing and notification payloads by event contract', async () => {
    ...
    const eventBus = {
      subscribe: jest.fn((eventType: string, handler: (event: any) => Promise<void>) => {
